...
public class DBConnectionTest2Test {
    ...
    public void insertUserTest() throws  Exception {
        User user = new User("asdf24", "1234", "abc", "aaaa@aaa.com", "010", "960512", new Date());
        deleteAll();
    ...
    public void selectUserTest() throws Exception {
        deleteAll();
        User user = new User("asdf", "1234", "abc", "aaaa@aaa.com", "010", "960512",  new Date());
        int rowCnt = insertUser(user);
        User user2 = selectUser("asdf42");
    ...
    public void deleteUserTest() throws Exception {
        ...
        User user = new User("asdf2", "1234", "abc", "aaaa@aaa.com", "fb", "960512",  new Date());
